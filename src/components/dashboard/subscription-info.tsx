	...
	if (
		...
		return (
			<SubscriptionCard
				...
				description={
					<>
						Вы выбрали тариф <strong>{user.subscription.plan.title}</strong>, но
	...
	return (
		<SubscriptionCard
			action={
				<Button
					variant='outline'
					onClick={() => mutate({ isAutoRenewal: !user.isAutoRenewal })}
					className='w-full'
				>
		...
		>
			<div className='flex items-center justify-between'>
				...
				<span className='font-semibold'>{user.subscription.plan.title}</span>
			</div>
